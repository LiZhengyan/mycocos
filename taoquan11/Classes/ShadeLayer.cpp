...
//    this->addChild(whiteBG);
    ...
    yongshi->setPosition(Vec2(visibleSize.width*0.45, visibleSize.height/2.1));
...
//    this->addChild(shi,2);
    ...
    miao->setPosition(Vec2(labelTime->getPositionX()+miao->getContentSize().width*1.5, visibleSize.height/2.1));
