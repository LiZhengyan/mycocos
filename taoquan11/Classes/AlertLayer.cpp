...
bool AlertLayer::init() {
    ...
    xiaohaoSP->setPosition(Vec2(visibleSize.width/2,visibleSize.height*0.6));
    ...
    startItem->setPosition(Vec2(visibleSize.width*0.5,origin.y + visibleSize.height*0.5));
    ...
    backLastItem->setPosition(Vec2(visibleSize.width*0.5,origin.y + visibleSize.height*0.4));
