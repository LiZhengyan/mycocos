...
bool Setting::init()
{
	...
	Sprite *bg = Sprite::createWithSpriteFrameName("setting-back.png");
	...
	//on off 音效精灵
	Sprite *soundOnSprite = Sprite::createWithSpriteFrameName("on.png");
	Sprite *soundOffSprite = Sprite::createWithSpriteFrameName("off.png");

	//on off 音效菜单项
	auto soundOnMenuItem = MenuItemSprite::create(
		soundOnSprite, 
		soundOnSprite);
	auto soundOffMenuItem = MenuItemSprite::create(
		soundOffSprite,
		soundOffSprite);
	...
	//on off 音乐精灵
	Sprite *musicOnSprite = Sprite::createWithSpriteFrameName("on.png");
	Sprite *musicOffSprite = Sprite::createWithSpriteFrameName("off.png");

	//on off音乐菜单项
	auto musicOnMenuItem = MenuItemSprite::create(
		musicOnSprite, 
		musicOnSprite);
	auto musicOffMenuItem = MenuItemSprite::create(
		musicOffSprite,
		musicOffSprite);
	...
	//Ok按钮
	Sprite *okSpriteNormal = Sprite::createWithSpriteFrameName("ok-up.png");
	Sprite *okSpriteSelected = Sprite::createWithSpriteFrameName("ok-down.png");

	auto okMenuItem  = MenuItemSprite::create( 
		okSpriteNormal,
		okSpriteSelected,
