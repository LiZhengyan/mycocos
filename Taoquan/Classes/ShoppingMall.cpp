...
bool ShoppingMall::init()
{
    ...
    _haveNumber=LabelAtlas::create(ownChar, "shop/shuzi.png", 47.3f, 56.0f, '0');
    ...
    _effect->setPosition(Vec2(visibleSize.width*0.56, visibleSize.height*0.7));
...
void ShoppingMall::menuFileButtonCallback(Ref* pSender)
{
    ...
    //_effect->setPosition(Vec2(visibleSize.width*0.42, visibleSize.height*0.7));
...
void ShoppingMall::menuHelpButtonCallback(Ref* pSender)
{
    ...
    _effect->setTexture(texture);
    char ownChar[10];
    sprintf(ownChar, "%d",_helpPropNumber);
    _haveNumber->setString(ownChar);
}
...
void ShoppingMall::menuQuanButtonCallback(Ref* pSender)
{
    ...
    _effect->setTexture(texture);
    char ownChar[10];
    sprintf(ownChar, "%d",_circlePropNumber);
    _haveNumber->setString(ownChar);
}
