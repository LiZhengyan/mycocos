...
//    this->addChild(layerColor);7
    ...
    yong->setPosition(Vec2(visibleSize.width/2-yong->getContentSize().width*1.5, visibleSize.height/2));
    this->addChild(yong,2);
    Sprite* shi=Sprite::create("guoguan/yongshi.png",Rect(58, 0, 58, 57));
    shi->setPosition(Vec2(visibleSize.width/2-yong->getContentSize().width*0.5, visibleSize.height/2));
    ...
    miao->setPosition(Vec2(visibleSize.width/2+yong->getContentSize().width*1.5, visibleSize.height/2));
