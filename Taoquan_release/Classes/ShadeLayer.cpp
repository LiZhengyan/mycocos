...
//    this->addChild(whiteBG);
    ...
    yongshi->setPosition(Vec2(visibleSize.width*0.43, visibleSize.height*0.46));
...
//    this->addChild(shi,2);
    ...
    LabelAtlas* labelTime = LabelAtlas::create(timeChar, "guoguan/shuzi.png", 22.0f, 94.0f, '0');
    ...
    labelTime->setPosition(Vec2(visibleSize.width*0.51, visibleSize.height*0.46));
    this->addChild(labelTime, 2);
    Sprite* miao=Sprite::create("guoguan/miao.png");
    miao->setPosition(Vec2(visibleSize.width*0.6, visibleSize.height*0.46));
